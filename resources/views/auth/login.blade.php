...
<body class="bg-gray-100 min-h-screen relative overflow-x-hidden">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center relative z-10">
        <div class="card-dark p-10 rounded-2xl shadow-2xl w-96 border-2 border-pink-500">
            <h2 class="text-3xl font-extrabold mb-6 text-center text-white">Login</h2>
            <form action="{{ isset($role) && $role === 'admin' ? route('admin.login') : route('student.login') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label class="block text-pink-200 text-sm font-bold mb-2" for="email">
                        Email
                    </label>
                    <input class="shadow appearance-none border border-pink-400 rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:ring-2 focus:ring-pink-500"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input class="shadow appearance-none border border-pink-400 rounded w-full py-2 px-3 text-gray-900 mb-3 leading-tight focus:outline-none focus:ring-2 focus:ring-pink-500"
                ...
                <div class="flex items-center justify-between">
                    <button class="gradient-bg text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full"
                        type="submit">
                        Sign In
                    </button>
                </div>
